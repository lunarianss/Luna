...
func (ac *AppController) UpdateAppApiEnable(c *gin.Context) {
	params := &dto.EnableAPIRequest{}
	...
	appDetail, err := ac.appService.UpdateEnableAppApi(c, userID, paramsUrl.AppID, params.EnableAPI)
