...
func (ac *ChatController) AudioToChatMessage(c *gin.Context) {
	...
	if transcription, err := ac.chatService.AudioToText(c, audioFileContent, audioFile.Filename, paramsUrl.AppID, userID); err != nil {
		core.WriteResponse(c, err, nil)
	} else {
