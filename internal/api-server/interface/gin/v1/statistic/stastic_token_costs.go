...
func (sc *StatisticController) TokenCosts(c *gin.Context) {
	...
	statisticData, err := sc.statisticService.SumTokenCosts(c, paramsUrl.AppID, userID, paramsQuery.Start, paramsQuery.End)
