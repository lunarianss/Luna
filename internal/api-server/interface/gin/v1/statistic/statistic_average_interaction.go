...
func (sc *StatisticController) AverageInteraction(c *gin.Context) {
	...
	statisticData, err := sc.statisticService.AverageInteractions(c, paramsUrl.AppID, userID, paramsQuery.Start, paramsQuery.End)
