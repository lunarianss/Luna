...
func (sc *StatisticController) DailyConversations(c *gin.Context) {
	...
	statisticData, err := sc.statisticService.DailyConversations(c, paramsUrl.AppID, userID, paramsQuery.Start, paramsQuery.End)
