...
func (sc *StatisticController) DailyMessages(c *gin.Context) {
	...
	statisticData, err := sc.statisticService.DailyMessages(c, paramsUrl.AppID, userID, paramsQuery.Start, paramsQuery.End)
